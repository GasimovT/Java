        ...
        try {
            ...
            while (scanner.hasNextLine()) {
                ...
                if (classCount > 0) {
                    ...
                    double roundedGpa = Double.parseDouble(df.format(gpaCalc));
                    gpa.add(roundedGpa);
            ...
            if (students.size() > 0) {
                for (int i = 0; i < students.size(); i++) {
                    System.out.println(students.get(i) + "\t\t" + " " +
                            classes.get(i) + "\t\t" + " " + credits.get(i) + "\t\t" + gpa.get(i));
                }
            }
            ...
            System.out.println();
            System.out.println("The top student is " + students.get(indexOfTopStudent) + " with GPA " + topStudentGpa);
            ...
            double averageOfAllGpaRounded = 0;
            if (gpaCount > 0) {
                double averageOfAllGpa = gpaSum / gpaCount;
                DecimalFormat df = new DecimalFormat("#.00");
                averageOfAllGpaRounded = Double.parseDouble(df.format(averageOfAllGpa));
                System.out.println();
                System.out.println("The average of all GPAs is " + averageOfAllGpaRounded);
                System.out.println();
            }
            ...
            for (int i = 0; i < gpa.size(); i++) {
                if (gpa.get(i) > averageOfAllGpaRounded) {
                    System.out.println(students.get(i) + "\t\t" + gpa.get(i));
                }
            }
