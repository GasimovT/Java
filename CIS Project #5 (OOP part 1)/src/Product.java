...
public class Product {
    ...
    /*
    If output of totalValue calculation is 5.2, it will be converted into 5.20. As a result, trailing 0s
    will not be lost and be limited to two decimal places.
     */
    public String productTotalValue() {

        double totalValue = this.qtyOnHand * this.unitPrice;
    ...
    public String productInformation(boolean isFullData) {
        if (isFullData) {
            return "Product name: " + this.productName + "\nProduct Description: " + this.productDescription +
                    ...
                    + this.unitPrice + "\nTotal product value: $" + productTotalValue();
        }
        return this.productName;
    }
